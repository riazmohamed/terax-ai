...
/** Resolve any model id — built-in, compat endpoint, or user-registered
 *  `custom:*` — to a ModelInfo. Returns null for an unknown id (e.g. a custom
 *  model deleted while still selected). Never throws, unlike {@link resolveModel}. */
export function resolveModelOrNull(
  id: string,
  endpoints: readonly CustomEndpoint[] = [],
