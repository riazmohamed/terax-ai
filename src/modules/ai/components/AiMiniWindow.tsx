...
import { estimateCost, getModelContextLimit, resolveModelOrNull } from "../config";
...
function ContextIndicator({ messages }: { messages: UIMessage[] }) {
  ...
  const modelLabel = useMemo(() => {
    return (
      resolveModelOrNull(modelId, customEndpoints, customModels)?.label ??
      modelId
    );
  }, [modelId, customEndpoints, customModels]);
